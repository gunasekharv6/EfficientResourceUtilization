 ...
 * @author manojreddy
 */
public class CreateNewCityOfficialJPanel extends javax.swing.JPanel {

    /**
     * Creates new form CreateNewCityOfficialJPanel
     */
    ...
    private void initComponents() {
        ...
        headerjLabel.setText("Create New City Official");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(207, 289, Short.MAX_VALUE))
        );
    ...
    private void savejButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savejButtonActionPerformed
        ...
        if(isDataEnteredValid()) {
            ...
            CityOfficial cityOfficial = new CityOfficial(name, phoneNo, email, address, userName, password, UserRole.CityOfficial, imagePath,
                new Date(), new Date(), userLogged.getName(), userLogged.getName());
            cityNetwork.getCityOfficialsDirectory().getCityOfficials().add(cityOfficial);

            JOptionPane.showMessageDialog(this, "Successfully saved new City Official");
            resetUi();
        }else{
            JOptionPane.showMessageDialog(this, "Error saving new City Official. Please check DataTypes");
        }
